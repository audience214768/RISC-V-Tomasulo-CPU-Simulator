...
class RSModule {
    struct Entry {
        ...
        void hold() {
            ...
            pred_taken.hold(); pred_target.hold(); ras_snap.hold();
        }
        void tick() {
            ...
            pred_taken.tick(); pred_target.tick(); ras_snap.tick();
        }
        void reset() {
            ...
            pred_taken.reset(0); pred_target.reset(0); ras_snap.reset(0);
        }
    };
...
public:
    ...
    void drive_read_ports(RSReadPorts &p) {
        ...
        for (int i = 0; i < RS_SIZE; i++) {
            ...
            p.ras_snap[i].write(entries_[i].ras_snap.cur());
